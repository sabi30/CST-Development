...
namespace cst::simd {
    ...
    typedef float f32x2 __attribute__((__ext_vector_type__(2)));
    typedef i32 i32x4 __attribute__((__ext_vector_type__(4)));
    typedef u8 u8x16 __attribute__((__ext_vector_type__(16)));
